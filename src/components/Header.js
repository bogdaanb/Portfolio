...
import { ReactComponent as Arrow90Right } from "../img/arrow-90deg-right.svg";
    ...
    <div>
      ...
      >
        <nav className="flex space-x-4">
          <button className="flex items-center text-[#303030] dark:text-[#f2f0ef]">
            Story
            <ArrowRight className="ml-2 w-4 h-4 fill-current" />
          </button>
          <button className="flex items-center text-[#303030] dark:text-[#f2f0ef]">
            Projects
            <Arrow90Right className="ml-2 w-4 h-4 fill-current" />
          </button>
          <button className="flex items-center text-[#303030] dark:text-[#f2f0ef]">
            Contact
            <ArrowUpRight className="ml-2 w-4 h-4 fill-current" />
          </button>
        </nav>
